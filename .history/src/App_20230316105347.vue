...
watch(count,(val,oldVal)=>{
  console.log("%c  === -> line:13 oldVal::: ","font-size: 15px;color: #F56C6C;", oldVal);
  console.log(" %c -> 213   === %o ::: ", "font-size: 15px;color: green;", 213);
console.log(" %c :::   === -> ", "font-size: 15px;color: green;", );
