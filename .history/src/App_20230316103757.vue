...
watch(count,(val,oldVal)=>{
  console.log("-> %c 23213   === %o ::: ", "font-size: 15px;color: green;", 23213);
  
  console.log("line:13 %c oldVal->  === %o", "font-size: 15px;color: green; ", oldVal, "");
  
  
  console.log('val"-> %c   === %o", "font-size: 15px;color: green;",  ', val, 'line:13');
