...
onMounted(()=>{
   timer.value = setInterval(() => {
    console.log("%c  === -> line:9 setInterval》〉》〉》〉》〉》 ","font-size: 15px;color: #F56C6C;", setInterval);
    console.log("%c  === -> line:9 setIntervallove ","font-size: 15px;color: #F56C6C;", setInterval);
    console.log("%c  === -> line:9 setInterval::: ","font-size: 15px;color: #F56C6C;font-weight: bolder;", setInterval);
    count.value++
  }, 200);
})
